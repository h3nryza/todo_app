...
VERSION="${OHRIGHT_VERSION:-0.0.1-alpha}"
...
<head>
<meta charset="utf-8">
<title>Oh Right Security Dashboard - ${PLATFORM}</title>
<style>
...
<body>
<div class="header">
  <h1>Oh Right &mdash; Security Dashboard</h1>
...
<div class="container">
  ...
  <div class="footer">
    Oh Right &middot; Security Dashboard &middot; Generated by Trivy + Oh Right CI/CD Pipeline
  </div>
</div>
</body>
</html>
